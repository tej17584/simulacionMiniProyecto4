...
class Board:
    ...
    def player2Turn(self,isRandom=False):
        ...
        print("Calculating best move with Montecarlo algorithm")
        if(isRandom):
            choice = random.randint(1,5)
        else:
            print("\nMove: ")
    ...
    def playWithComputer(self, iterations=0):
        '''Play with Dummy computer. Computer will play with you with random moves, 
        no intelligence or cheating. And we take de ITERATIONS parameter and use it in the montecarlo algorithm'''
        i = 0
        self.printBoard_pretty()
        while(self.finish == False and self.finishTurns == False):
            ...
            while(self.tryAgainP1 == True and self.finishTurns == False):
                ...
                iterationstouse=iterationstouse+1
                self.player1Turn()
...
def menu():
    exit = 0
    print("--------------------------------------------------------------------------------------")
    print(" 1. Play with dummy computer")
    print(" 2. Play with advanced computer")
    print(" 3. Play with pro computer")
    print(" 4. Print board")
    print(" 5. Exit (Press 6 until exit)")
    ...
    if choice == 1:
        print(" ")
        mancala.playWithComputer(iterations=0) #PASAMOS LAS 0 iteraciones
        menu() 
    elif choice == 2:
        print(" ")
        mancala.playWithComputer(iterations=500)#PASAMOS LAS 500 iteraciones
        menu() 
    elif choice == 3:
        print(" ")
        mancala.playWithComputer(iterations=10000)#PASAMOS LAS 100000 iteraciones
        menu() 
    elif choice == 4:
        print(" ")
